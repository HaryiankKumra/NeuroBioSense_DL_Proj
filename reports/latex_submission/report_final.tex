...
\textbf{Metadata-Assisted} & Highest standalone baseline (60.09\%); no sensor hardware; bypasses alignment issue entirely; fast inference. & Requires ad-level demographic metadata at inference; no physiological or visual generalisation. \\ \bottomrule
\end{tabular}%
}
\end{table}
